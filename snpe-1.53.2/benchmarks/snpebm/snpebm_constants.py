...
SNPE_BENCH_QNX64_GCC83_ARTIFACTS_JSON = "snpebm_artifacts_qnx64_gcc83.json"
SNPE_BENCH_AARCH64_UBUNTU_GCC75_ARTIFACTS_JSON = "snpebm_artifacts_aarch64_ubuntu_gcc75.json"
SNPE_BENCH_AARCH64_OE_LINUX_GCC93_ARTIFACTS_JSON = "snpebm_artifacts_aarch64_oe_linux_gcc93.json"
...
RUNTIME_BUFFER_MODES = {
    ...
    'DSP_ACT16': ['float', 'ub_float', 'ub_tf16'],
    'GPU': ['float', 'ub_float'],
    'GPU_FP16': ['float', 'ub_float'],
    'AIP': ['float', 'ub_float','ub_tf8'],
    'AIP_ACT16': ['float', 'ub_float', 'ub_tf16']
}

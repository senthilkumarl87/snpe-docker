...
error_codes_to_messages = {
    ...
    'ERROR_UNSUPPORTED_COLOR_TRANSFORMATION': "Unsupported color transformation {} to {}. Support includes [ARGB|RGBA|NV21]To[RGB|BGR] transformations.",
...
warning_codes_to_messages = {
    ...
    # //=============================================================================
    "WARNING_BROADCAST_POW": "Dynamic broadcast Pow operations is not supported",
    ...
    "WARNING_STATIC_SHAPE": "Only static shape ops are supported. The op: {} will be interpreted at conversion time",
